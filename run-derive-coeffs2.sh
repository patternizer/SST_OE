...
#echo '. /gws/smf/j04/esacci_sst/software/miniconda3/etc/profile.d/conda.sh' > run.ma_2011.sh
...
bsub -q short-serial -W24:00 -R rusage[mem=60000] -M 60000 -oo\
 run.ma_2006.log < run.ma_2006.sh
bsub -q short-serial -W24:00 -R rusage[mem=60000] -M 60000 -oo\
 run.ma_2007.log < run.ma_2007.sh
bsub -q short-serial -W24:00 -R rusage[mem=60000] -M 60000 -oo\
 run.ma_2008.log < run.ma_2008.sh
bsub -q short-serial -W24:00 -R rusage[mem=60000] -M 60000 -oo\
 run.ma_2009.log < run.ma_2009.sh
bsub -q short-serial -W24:00 -R rusage[mem=60000] -M 60000 -oo\
 run.ma_2010.log < run.ma_2010.sh
bsub -q short-serial -W24:00 -R rusage[mem=60000] -M 60000 -oo\
 run.ma_2011.log < run.ma_2011.sh
bsub -q short-serial -W24:00 -R rusage[mem=60000] -M 60000 -oo\
 run.ma_2012.log < run.ma_2012.sh
bsub -q short-serial -W24:00 -R rusage[mem=60000] -M 60000 -oo\
 run.ma_2013.log < run.ma_2013.sh
bsub -q short-serial -W24:00 -R rusage[mem=60000] -M 60000 -oo\
 run.ma_2014.log < run.ma_2014.sh
bsub -q short-serial -W24:00 -R rusage[mem=60000] -M 60000 -oo\
 run.ma_2015.log < run.ma_2015.sh
bsub -q short-serial -W24:00 -R rusage[mem=60000] -M 60000 -oo\
 run.ma_2016.log < run.ma_2016.sh
bsub -q short-serial -W24:00 -R rusage[mem=60000] -M 60000 -oo\
 run.ma_2017.log < run.ma_2017.sh
