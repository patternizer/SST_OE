...
def run_checking_plots(mpclr, f3, f4, f5, fx3, fx4, fx5, fw3, fw4, fw5, x, \
    ...
    ax1.set_title('Hitosgram of lon and lat')
    ...
    ax1.set_title('Hitosgram of lat')
    ...
    ax2.set_title('Hitosgram of lon')
    ...
    ax3.set_title('Global distribution')
...
def diagnostic_plots(xret, xd3, solz, satz, lat, lon, time, elem, \
    ...
    for i in invars: 
        ...
        print('IN DIAGNOSTIC_PLOTS: i=',str(i))
...
def calc_obs(calinfo, beta, tinst):
